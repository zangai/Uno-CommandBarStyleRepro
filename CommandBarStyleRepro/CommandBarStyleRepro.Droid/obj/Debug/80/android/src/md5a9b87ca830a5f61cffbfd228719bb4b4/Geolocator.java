package md5a9b87ca830a5f61cffbfd228719bb4b4;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Geolocation.Geolocator, Uno", Geolocator.class, __md_methods);
	}
	...
	public Geolocator ()
	{
		...
		if (getClass () == Geolocator.class)
			mono.android.TypeManager.Activate ("Windows.Devices.Geolocation.Geolocator, Uno", "", this, new java.lang.Object[] {  });
	}
