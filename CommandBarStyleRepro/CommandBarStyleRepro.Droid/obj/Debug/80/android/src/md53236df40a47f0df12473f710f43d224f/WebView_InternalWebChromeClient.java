...
public class WebView_InternalWebChromeClient
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.UI.Xaml.Controls.WebView+InternalWebChromeClient, Uno.UI", WebView_InternalWebChromeClient.class, __md_methods);
	}


	public WebView_InternalWebChromeClient ()
	{
		super ();
		if (getClass () == WebView_InternalWebChromeClient.class)
			mono.android.TypeManager.Activate ("Windows.UI.Xaml.Controls.WebView+InternalWebChromeClient, Uno.UI", "", this, new java.lang.Object[] {  });
	}
