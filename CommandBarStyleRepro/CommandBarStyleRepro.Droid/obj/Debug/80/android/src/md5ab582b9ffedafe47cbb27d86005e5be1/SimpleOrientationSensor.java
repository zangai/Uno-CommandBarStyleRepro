package md5ab582b9ffedafe47cbb27d86005e5be1;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Windows.Devices.Sensors.SimpleOrientationSensor, Uno", SimpleOrientationSensor.class, __md_methods);
	}


	public SimpleOrientationSensor ()
	{
		super ();
		if (getClass () == SimpleOrientationSensor.class)
			mono.android.TypeManager.Activate ("Windows.Devices.Sensors.SimpleOrientationSensor, Uno", "", this, new java.lang.Object[] {  });
	}
